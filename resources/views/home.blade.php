...
@section('content')
    @can('view-dashboard')
        ...
        <div class="container-fluid mt-5">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card" style="overflow-x: auto;">
                        <h5 class="card-header">Data Pesanan Hari ini</h5>
                        <hr />
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title">Total Penjualan Per Sub Produk per Bulan</h5>
                    <hr />
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(function(item) {
                                ...
                                if (item.long_item && item.width_item) {
                                    parts.push(`${item.long_item} x ${item.width_item}`);
                                }

                                if (item.additional_size && item.additional_unit) {
                                    parts.push(`${item.additional_size} ${item.additional_unit}`);
                                }
                                ...
                                html += '<tr>' +
                                    '<td>' + no + '</td>' +
                                    '<td>' + itemName + '</td>' +
                                    '<td>' + (item.label_name ? item.label_name + ' ' : '') + '</td>' +
