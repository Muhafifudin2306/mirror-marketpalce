...
<main class="py-5">
  <div class="container">
    <h2 class="mb-4">Detail Customer</h2>
      ...
      <div class="card-body">
        <div class="row gx-5">
          ...
          <div class="col-md-9">
            ...
            <div class="mt-4">
              <a href="{{ route('admin.customer.index') }}" class="btn btn-outline-secondary me-2">Kembali</a>
              <a href="{{ route('admin.customer.edit', $rs->id) }}" class="btn btn-primary">Edit User</a>
            </div>
          </div>
        </div>
      </div>
