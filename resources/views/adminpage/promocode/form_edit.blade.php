    ...
    <main>
        <div class="container-fluid px-4">
            <div class="container px-5 my-5">
                <h2>Form Edit Kode Promo</h2>
                <form method="POST" action="{{ route('admin.promocode.update', $row->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-floating mb-3">
                        <input
                            ...
                            value="{{ old('discount_percent', $row->discount_percent) }}"
                    ...
                    <div class="form-floating mb-3">
                        <input
                            ...
                            value="{{ old('discount_fix', $row->discount_fix) }}"
                    ...
                    <div class="form-floating mb-3">
                        <input
                            ...
                            value="{{ old('max_discount', $row->max_discount) }}"
                    ...
                    <div class="form-floating mb-3">
                        <input
                            ...
                            value="{{ old('start_at', \Carbon\Carbon::parse($row->start_at)->format('Y-m-d')) }}"
                    ...
                    <div class="form-floating mb-3">
                        <input
                            ...
                            value="{{ old('end_at', \Carbon\Carbon::parse($row->end_at)->format('Y-m-d')) }}"
