...
@section('content')
    <div class="container-fluid container-p-y">
        ...
        <div class="card" style="overflow-x: auto;">
            ...
            <div class="card-body">
                <x-filter-form :action="route('orders.canceled')" :reset-url="route('orders.canceled')" :show-spk="true" :show-invoice="false" :show-payment-method="false"
                        ...
                        <tbody>
                            @forelse($ar_order as $i => $order)
                                <tr>
                                    ...
                                    <td class="text-wrap">{{ $order->cancel_reason ?? '-' }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('orders.canceledShow', $order->id) }}">
        ...
        <div class="modal-dialog">
            <form id="downloadForm">
                <div class="modal-content">
                    ...
                    <button id="downloadButton" class="modal-footer">
                        <span class="button-text btn btn-success">Download
