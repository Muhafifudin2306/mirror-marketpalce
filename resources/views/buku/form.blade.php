        ...
        <div class="container-fluid px-4">
            <div class="container px-5 my-5">
                ...
                <form method="POST" action="{{ route('buku.store') }}" id="contactForm" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control @error('isbn') is-invalid @enderror" name="isbn" value="{{ old('isbn') }}" id="isbn" type="number" placeholder="ISBN" data-sb-validations="required" />
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control @error('rating') is-invalid @enderror" name="rating" value="{{ old('rating') }}" id="rating" type="number" placeholder="Rating" data-sb-validations="required|max:5" max="5" />
                    ...
                    <input type="hidden" name="url_buku" id="url_buku" value="">
